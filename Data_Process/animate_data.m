...
filename_mpc = "../data/Hard_Data/mpc_3.bag";
filename_main = "../data/Hard_Data/main_3.bag";

% filename_mpc = "../data/Sim_Data/mpc_test_2024_09_10_20_32_50.bag";
% filename_main = "../data/Sim_Data/test_2024_09_10_20_32_50.bag";
...
for k = 1:5:numel(mpc_msgs) - 20
    ...
    %     'MarkerFaceColor','g')
    plot(x_offset + obs_pos(1) + x_cir * 0.14, y_offset + obs_pos(2) + y_cir * 0.14)
    hold off
    xlim([-2 2])
    ylim([-2 2])
    frame = getframe(1);
